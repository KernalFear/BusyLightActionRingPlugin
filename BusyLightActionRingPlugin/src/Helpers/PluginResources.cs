namespace Loupedeck.BusyLightActionRingPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.BusyLightActionRingPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.BusyLightActionRingPlugin.Resources.Resource.txt`.
